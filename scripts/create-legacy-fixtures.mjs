...
create('repeatable-v1.sqlite', [
  ...
  ['bitacora:t:repeatable-v1-task', JSON.stringify({
    ...
    f3: {
      iteraciones: [
        {
          id: 'repeatable-iter-1',
          methodVersionId: 'method-v1',
          objetivo: 'Ejecutar la version estable',
          intento: 'Primera corrida controlada',
          resultado: 'Resultado funcional consistente',
          ajuste: 'Mantener el flujo base',
          criterioIds: [],
          action: 'Ejecutar la secuencia completa',
          tool: 'CLI',
          input: 'Entrada base',
          result: 'Salida estable',
          evidence: [{ id: 'repeatable-ev-1', kind: 'note', label: 'Bitacora 1', value: 'La salida coincide con el criterio esperado' }],
          learning: 'La secuencia se sostiene con la misma entrada',
          nextAdjustment: 'No aplica',
          applicableConditions: ['Misma version', 'Entrada estable'],
          success: true,
          successCriteriaResults: [{ criterion: 'Completado funcional', passed: true }],
          createdAt: now(),
        },
        {
          id: 'repeatable-iter-2',
          methodVersionId: 'method-v1',
          objetivo: 'Repetir la version estable',
          intento: 'Segunda corrida controlada',
          resultado: 'Resultado funcional consistente',
          ajuste: 'Sin cambios materiales',
          criterioIds: [],
          action: 'Ejecutar la secuencia completa',
          tool: 'CLI',
          input: 'Entrada base',
          result: 'Salida estable',
          evidence: [{ id: 'repeatable-ev-2', kind: 'note', label: 'Bitacora 2', value: 'La repeticion mantiene el mismo resultado' }],
          learning: 'La misma version vuelve a cumplir bajo condiciones comparables',
          nextAdjustment: 'No aplica',
          applicableConditions: ['Misma version', 'Entrada estable'],
          success: true,
          successCriteriaResults: [{ criterion: 'Completado funcional', passed: true }],
  ...
  ['bitacora:t:material-v2-task', JSON.stringify({
    ...
    f3: {
      iteraciones: [
        {
          id: 'material-iter-1',
          methodVersionId: 'method-v2-base',
          objetivo: 'Completar la version base',
          intento: 'Corrida previa al cambio material',
          resultado: 'La version inicial cumple',
          ajuste: 'Materializar cambio',
          criterioIds: [],
          action: 'Ejecutar el flujo inicial',
          tool: 'Script',
          input: 'Entrada original',
          result: 'Salida original',
          evidence: [{ id: 'material-ev-1', kind: 'note', label: 'Bitacora base', value: 'La version inicial cumple antes del cambio material' }],
          learning: 'El flujo base funciona pero requiere una variante material',
          nextAdjustment: 'Materializar cambio',
          applicableConditions: ['Version inicial', 'Proveedor original'],
          success: true,
          successCriteriaResults: [{ criterion: 'Completado funcional', passed: true }],
          createdAt: now(),
        },
        {
          id: 'material-iter-2',
          methodVersionId: 'method-v2-material',
          objetivo: 'Validar la nueva version material',
          intento: 'Primera corrida de la version 2',
          resultado: 'La nueva salida cumple una vez',
          ajuste: 'No aplica',
          criterioIds: [],
          action: 'Ejecutar el nuevo flujo',
          tool: 'Script',
          input: 'Entrada nueva',
          result: 'Salida nueva',
          evidence: [{ id: 'material-ev-2', kind: 'note', label: 'Bitacora material', value: 'La nueva version cumple una vez con el criterio' }],
          learning: 'La evidencia de repetibilidad debe reiniciarse para la nueva version',
          nextAdjustment: 'No aplica',
          applicableConditions: ['Version material', 'Entrada nueva'],
          success: true,
          successCriteriaResults: [{ criterion: 'Completado funcional', passed: true }],
          createdAt: now(),
        },
