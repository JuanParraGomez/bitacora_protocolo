...
console.log('checkCompila', task.f3.checkCompila, 'checkAuditado', task.f3.checkAuditado);
console.log('reasons', gateReasons(task));
console.log('advance', canAdvance(task));
